...
export class TournamentEditComponent implements OnInit {
  ...
  DeleteAdmin(admin: String) {
    ...
    this.itemsAdmin.push({
      _id: this.adminsid[this.pos],
      name: this.admins[this.pos],
    });
    //eliminar el string
  ...
  onChangeArbiter(arbiter: Item) {
    ...
    this.itemsreferee = this.itemsreferee.filter(
      (adm) => adm._id !== arbiter._id
    );
  }
  ...
  DeleteArbiter(arbiter: string) {
    ...
    this.itemsreferee.push({
      _id: this.arbitersid[this.pos],
      name: this.arbiters[this.pos],
    });
  ...
  onChangeCoach(coach: Item) {
    ...
    this.itemsTrainers = this.itemsTrainers.filter(
      (adm) => adm._id !== coach._id
    );
  ...
  DeleteCoach(coach: string) {
    ...
    this.itemsTrainers.push({
      _id: this.coachsid[this.pos],
      name: this.coachs[this.pos],
    });
  ...
  Cancel() {
    const dialogRef = this.dialog.open(DialogCancelComponent, {
      ...
      height: '200px',
      data: {
        name: 'Los Cambios aplicados se perderan,',
        subname: '¿Deseas Continuar?',
      },
    });
    ...
    dialogRef.afterClosed().subscribe((result) => {
      if (result == true) {
        ...
        this.router.navigate([
          'admin/tournament/detail/' + this.id + '/status/' + this.status,
        ]);
      }
    });
  }
  ...
  CrearTou() {
    if (
      ...
      this.time == null ||
      this.date == null ||
      this.typeTournamet == null ||
      this.city == null ||
      this.place == null ||
      this.adminsid[0] == null ||
      this.arbitersid[0] == null ||
      this.coachsid[0] == null
    ) {
      ...
      if (this.id != null) {
        ...
        this.APIcreate.updateTournament(datasend, this.id).subscribe(
          (result) => {
            //console.log(result);
